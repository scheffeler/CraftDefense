...
export const ENEMY_CONFIGS: Record<EnemyTypeName, EnemyConfig> = {
  ...
  uruk_captain: {
    ...
    xpReward: 200,
    drops: [
      { itemId: "diamond",      chance: 1.0, count: 4 },
      { itemId: "iron_block",   chance: 1.0, count: 6 },
      { itemId: "sniper_rifle", chance: 0.6, count: 1 },
      { itemId: "sniper_ammo",  chance: 1.0, count: 24 },
      { itemId: "energy_cell",  chance: 1.0, count: 6 },
    ],
  },
  creeper: {
    type: "creeper",
