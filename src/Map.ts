...
export const BLOCK_DEFS: Record<BlockId, BlockDef> = {
  ...
  tnt:            { id: "tnt",            name: "TNT",            color: 0xcc2222, topColor: 0xdddddd, hardness: 0,    placeable: true,  transparent: false },
  pressure_plate: { id: "pressure_plate", name: "Pressure Plate", color: 0x999080,                    hardness: 0.2,  placeable: true,  transparent: true  },
};
