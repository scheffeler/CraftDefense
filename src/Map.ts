...
export const BLOCK_DEFS: Record<BlockId, BlockDef> = {
  ...
  campfire:         { id: "campfire",         name: "Campfire",         color: 0xff5500, topColor: 0xffaa00, hardness: 1.0,  placeable: true,  transparent: true  },
};
...
function getBlockTexIndex(id: BlockId, normalY: number): number {
  ...
  switch (id as string) {
    ...
    case "campfire":         return 13; // mesh-rendered, tile unused
    default:                 return 13;
  }
}
