// Screenshots the game at night for evaluation
...
// Wait a short bit and screenshot during daytime
await page.waitForTimeout(300);
await page.screenshot({ path: 'screenshots/current.png' });

// Take a longer wait and hope for sunset/sunrise screenshot
await page.screenshot({ path: 'screenshots/day.png' });
